...
import { Css, Html, Javascript, NodeJs } from "./TechIcons";
...
const Skills: React.FC = () => {
  const technicalSkills: Skill[] = [
    ...
    { name: "CSS", level: 85, icon: <Css className="w-6 h-6 text-purple" /> },
    {
      name: "JavaScript",
      level: 80,
      icon: <Javascript className="w-6 h-6 text-purple" />,
    },
    {
      name: "NodeJS",
      level: 75,
      icon: <NodeJs className="w-6 h-6 text-purple" />,
    },
    {
      name: "PostgreSQL",
      level: 70,
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="w-full md:w-1/2">
            <h3 className="text-xl font-semibold text-purple-dark mb-6">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {softSkills.map((skill, index) => (
                ...
                >
                  <span className="font-medium text-purple-darker">
                    {skill.name}
                  </span>
                </div>
              ))}
